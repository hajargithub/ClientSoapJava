...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "convertoDH", targetNamespace = "http://ws/", className = "proxy.ConvertoDH")
    @ResponseWrapper(localName = "convertoDHResponse", targetNamespace = "http://ws/", className = "proxy.ConvertoDHResponse")
    @Action(input = "http://ws/BanqueService/convertoDHRequest", output = "http://ws/BanqueService/convertoDHResponse")
